 ...
 */
final class Version20260610093141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE main_image ADD art_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_6661B7198C25E51A ON main_image (art_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6661B7198C25E51A ON main_image');
        $this->addSql('ALTER TABLE main_image DROP art_id');
